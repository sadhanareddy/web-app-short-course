...
class TestEmail(TestCase):
    ...
    def test_email_type(self):
        ...
        new_email = Email("sadhana@vlabs.ac.in")
        # correct email
        self.assertEqual(new_email.value, "sadhana@vlabs.ac.in")
        # incorrect email
...
class TestUser(TestCase):
    ...
    def test_user_creation(self):
        ...
        user = User(name=Name('sadhana'), email=Email('sadhana@vlabs.ac.in'), role=Role.admin)
        self.assertEqual(isinstance(user, User), True)
        self.assertEqual(user.name, 'sadhana')
        self.assertEqual(user.email, 'sadhana@vlabs.ac.in')
...
#+BEGIN_SRC python :tangle ../../tests/test_obj.py :eval no
    def test_user_get_email(self):
        ...
        user = User(name=Name('sadhana'), email=Email('sadhana@vlabs.ac.in'), role=Role.admin)
        self.assertEqual(user.get_email(), 'sadhana@vlabs.ac.in')
#+END_SRC
...
#+BEGIN_SRC python :tangle ../../tests/test_obj.py :eval no
    def test_user_get_name(self):
        ...
        user = User(name=Name('sadhana'), email=Email('sadhana@vlabs.ac.in'), role=Role.admin)
        self.assertEqual(user.get_name(), 'sadhana')
#+END_SRC
...
#+BEGIN_SRC python :tangle ../../tests/test_obj.py :eval no
    def test_make_user(self):
        ...
        name = Name('sadhana')
        email = Email('sadhana@vlabs.ac.in')
        role = Role.admin
